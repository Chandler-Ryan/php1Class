            ...
            <?php
                ...
                while($row = mysqli_fetch_array($result)){
                    echo "<tr>
                            ...
                            <td>{$row['ListPrice']}</td>
                            <td>
                                <a href=\"editproduct.php?id={$row['ProductID']}\" class=\"btn btn-outline-warning p-1\">Edit</a>
                                <a href=\"deleteproduct.php?id={$row['ProductID']}\" class=\"btn btn-outline-danger disabled p-1\">Delete</a>
                            </td>
                        </tr>";
                }
